...
function Navbar() {
  return (
    ...
    <ul className="flex justify-between items-center h-20">
        <li className="mr-3">
            <Link className="inline-block border bg-gradient-to-r from-indigo-500 border-b-blue-100 rounded-full py-2 px-4 bg-blue-500 hover:bg-blue-700 text-white ml-2" to="/learning/src/main/Home.js">Home</Link>
        </li>
        <li className="mr-3">
